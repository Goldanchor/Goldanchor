...
int64 nChainStartTime = 1523283042;
...
const string strMessageMagic = "Goldanchor Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	{
        nSubsidy =100000000.0 * COIN;//1000 0000
	}

  
	else if(nHeight > 20 && nHeight <= 10000100)
    {
        nSubsidy =0 * COIN;//900 0000
    }
	else if(nHeight > 10000100 && nHeight <= 60000000000000)
    {
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Goldanchor
    bool fStrictPayToScriptHash = true; // Always active in Goldanchor
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Goldanchor", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Apr 9, 2018 ,Score accumulate for VIP members";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x1d80ff2b55f4b73433a36142edeedead285e44b615232e7e5c0d13ab4a8f4ba8"));
...
unsigned char pchMessageStart[4] = { 0xa6, 0xb3, 0xc8, 0xde };
